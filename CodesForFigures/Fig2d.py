...
axes[0].set_xticklabels(my_label,font=font,rotation=0)
axes[1].set_xticklabels(my_label,font=font,rotation=0)
axes[2].set_xticklabels(my_label,font=font,rotation=0)
plt.show()